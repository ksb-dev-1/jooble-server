...
//         className="bg-primary text-light dark:text-dark hover:opacity-80 dark:hover:opacity-90 transition-opacity rounded p-2 sm:pl-2 sm:pr-4 py-2 flex items-center
...
//         <button
//           type="submit"
//           className="hidden sm:block bg-primary text-light dark:text-dark hover:opacity-80 dark:hover:opacity-90 transition-opacity rounded px-4 py-2"
...
//         className="bg-primary text-light dark:text-dark hover:opacity-80 dark:hover:opacity-90 transition-opacity rounded p-2 sm:pl-4 py-2 flex items-center
//         disabled:opacity-40 disabled:pointer-events-none"
